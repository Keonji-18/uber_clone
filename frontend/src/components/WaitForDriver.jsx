...
const WaitForDriver = ({setWaitForRidePanel, waitForRidePanelCloseRef})=>{
    return(

        <div>
            <h4 ref={waitForRidePanelCloseRef} onClick={() => setWaitForRidePanel(false)} className="p-1 text-center w-[93%] absolute top-0 ">
                <i className="text-3xl text-gray-200 ri-arrow-down-wide-line "></i>
            </h4>
            <h3 className="text-xl mb-4 font-semibold mt-3">Waiting for captain to Accept your Ride</h3>
            <div className="flex flex-col justify-between items-center gap-3" >
                ...
                <div className="w-full mt-2">
                    ...
                    <h4 className="font-semibold"> Captian is assigning shortly ....</h4>
            </div>
