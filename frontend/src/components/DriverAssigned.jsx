...
const DriverAssigned = ({setDriverAssigned, waitForRidePanelCloseRef}) =>{
    return(
            <div>
            <h4 ref={waitForRidePanelCloseRef} onClick={()=>{
            ...
            <div className="flex flex-col justify-between items-center gap-3" >
                ...
                <div className="w-full mt-2">
                    ...
                    <h4 className="font-semibold"> Captian is Ariving shortly ....</h4>
            </div>
